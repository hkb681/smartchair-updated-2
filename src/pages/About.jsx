  ...
  <>
    ...
    <section className="section">
      ...
      <div className={styles.statsGrid}>
        {[{num:'5+',label:'Happy Users'},{num:'2+',label:'Countries Served'},{num:'99.8%',label:'Uptime Reliability'}].map(s=>(
      ...
      <div className={styles.storyGrid}>
        <div><h3 className={styles.subHeading}>Our Story</h3><p className={styles.bodyText}>Founded in 2025 by Computer Science students, SmartChair was born from a simple observation existing wheelchair technology hadn't fundamentally changed in decades. As our Final Year Project, we set out to change that by combining AI, voice control, and obstacle detection into one smart, affordable solution built for Pakistan.</p></div>
